    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" style="">
        <div class="flex justify-between h-16">
            <div id="sidebar" class="sidebar close"
                style="background-color:grey; color: black; position: fixed; width: 30%; height: 100%; left: 0px;">
                <div class="body-sidebar" style="z-index:99; padding-top:10px; padding: 15px;">
                    <div class="side-header" style="font-size: 2em; padding: 15px;">Main navigation</div>
                    <div class="dashboard" style="border-radius: 5px; padding: 7px; margin: 20px 10px;"><a href="{{ route('profile.show') }}"
                            :active="request()->routeIs('profile')" class="active">{{ __('Profile') }}</a>
                    </div>
                    ...
                    <div class="dashboard" style="border-radius: 5px; padding: 7px; margin:20px 10px;"><a
                            href="{{ route('add') }}" :active="request()->routeIs('add')"
                            class="active">Add
                            transaction</a></div>
                              <div class="dashboard" style="border-radius: 5px; padding: 7px; margin:20px 10px;"><a
                ...
                <!-- <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <img src="{{ asset('images.jpg') }}" alt=""
                            style="width:100px; border-radius:8px; height:50px;">
                    </a>
                </div> -->
