          ...
          <nav>
            ...
            <ol
              ...
              <li class="leading-normal text-sm">
                <a class="opacity-50 text-slate-700" href="{{ route('check') }}"
                  >Pages</a
                >
              </li>
              <li
...
<!-- php logic for dynamic data from transaccontroller -->
                <?php
...
$users = in_array("user", $decoded) == 1 ? 'true' : 'false';

$total_user = count($user);
$total_party = count($party);
// print_r($valid);
// var_dump(in_array("add_user", $decoded));
              ...
              <div class="flex-auto p-4">
                <div class="flex flex-row -mx-3">
                  ...
                  <div class="px-3 text-right basis-1/3">
                    <a href="{{$valid == 'true' ? route('transaction') : " " }}">
                    <div
                ...
                <div class="flex flex-wrap -mx-3">
                  <div class="max-w-full px-3 lg:w-1/2 lg:flex-none">
                    <div class="flex flex-col h-full">
                      ...
                      <h5 class="font-bold">The Money Club</h5>
                      <p class="mb-12">
                       Money Club is your secure hub for financial transactions and hassle-free registrations. Built for trust, speed, and simplicity
                      </p>
                      <!-- <a
              ...
              <div
                ...
                <div class="relative z-10 flex flex-col flex-auto h-full p-4">
                  <h5 class="pt-2 mb-6 font-bold text-white">
                    Making Money Management Easy for Everyone.
                  </h5>
                  <p class="text-white">
                  Manage your money with confidence – quick registrations, reliable records, and smooth transactions at Money Club.
                  </p>
                  <!-- <a
          ...
          <div
            ...
            <div
              ...
              <div class="flex-auto p-4">
                ...
                <h6 class="mt-6 mb-0 ml-2">Users</h6>
  ...
  <div
    ...
    <script>
    const ctz = document.getElementById("chart-line").getContext("2d");

    new Chart(ctz, {
        type: 'line',
        data: {
            labels: @json($labels1), // Months
            datasets: [
                {
                    label: 'Income',
