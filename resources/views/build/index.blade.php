...
<html>
  <head>
    ...
    <!-- <scripts
      ...
      <!-- Font Awesome 6 CDN (no integrity check) -->
      ...
      <div class="mx-4">
        ...
        <div
          ...
          <div
            ...
            style="
              background-image: url('{{ asset('/assets/img/curved-images/white-curved.jpeg') }}');
            "></div>
                      ...
                      <tr>
                        <td
                          ...
                          <div class="flex px-2 py-1">
                            <div>
                              <img
                                src="{{ asset('/assets/img/small-logos/logo-xd.svg') }}"
                      ...
                      <tr>
                        <td
                          ...
                          <div class="flex px-2 py-1">
                            <div>
                              <img
                                src="{{ asset('/assets/img/small-logos/logo-atlassian.svg') }}"
                                class="inline-flex items-center justify-center mr-4 text-sm text-white transition-all duration-200 ease-soft-in-out h-9 w-9 rounded-xl"
                                alt="atlassian" />
                            </div>
                            <div class="flex flex-col justify-center">
