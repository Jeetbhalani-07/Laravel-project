        ...
        <div style="margin-top:20px;">
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg " style="padding:20px 20px;">
                    <h1 style="text-align:center; font-size: 2em;"><i>Party List</i></h1>
    @if(session('error'))
                    ...
                    <div style="display:block;margin:15px 20px; padding:5px 5px;">
                        <div style="float:right; padding: 5px 5px;">
                            ...
                            <a href="{{ route('add_party') }}" class="btn btn-primary">Add here</a>
                    ...
                    <table border="1" class="table table-striped table-bordered border-dark">
                        ...
                        @foreach ($party as $item)
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><a href="party/edit/{{ $item['id'] }}" class="btn btn-primary"><i class="fa-solid fa-pencil"></i></a>
                                                                <a href="party/delete/{{ $item['id'] }}" class="btn btn-danger"><i class="fa-solid fa-trash"></i></a>
                                                            </td>
                                                        </tr>
